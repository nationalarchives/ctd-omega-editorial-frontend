...
import uk.gov.nationalarchives.omega.editorial.connectors.{ JmsRequestReplyClient, JmsRequestReplyClientFactory, RequestReplyHandler }
...
abstract class BaseRequestReplyServiceISpec
  ...
  override def withFixture(test: OneArgAsyncTest): FutureOutcome = {
    val jmsRequestReplyClientFactory = new JmsRequestReplyClientFactory()
    val clientResource: Resource[IO, JmsRequestReplyClient[IO]] = jmsRequestReplyClientFactory.createForSqs[IO](
